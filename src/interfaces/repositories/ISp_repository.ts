...
interface IServiceProviderRepository{
    ...
    saveServiceProvider(serviceProvider:IService_provider):Promise<IService_provider | null>
    saveServiceProviderDetails(ServiceProviderDetails: IService_provider): Promise<IService_provider | null>
}
